...
const About = () => {
  ...
  return (
    ...
    <div className="flex flex-col md:flex-row p-2 justify-around mb-8 w-full lg:w-5/6 mx-auto my-auto">
      {/* Div 1 - Text */}
      <div className="justify-center md:pt-64 md:fixed w-full md:w-5/12 md:left-32 mb-8 md:mb-0 px-2">
      ...
      {/* Div 2 - Image */}
      <div className="grid grid-col-2 gap-8 md:mt-4
      mx-auto justify-items-center montserrat md:absolute w-full md:w-5/12 md:right-32"> 
        {users.map((user) => (
