  ...
  return (
    <Layout title="Inteli Blockchain">
      ...
      <div className="flex flex-col md:flex-row p-2 justify-around mb-8 w-full lg:w-5/6 mx-auto my-auto">
        {/* Div 1 - Text */}
        <div className="md:w-1/2 lg:w-1/2 w-full justify-center py-8">
        ...
        {/* Div 2 - Image */}
        <div className="grid grid-cols-2 gap-8 md:mt-4 w-full md:w-1/2 mx-auto justify-items-center montserrat">
          {users.map((user) => (
